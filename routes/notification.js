...
router.get("/:user_id", async (req, res) => {
  ...
  res.status(200).json({
    ...
    status: "200 - Ok",
    message:
      "List of notifications for user " + user_id + " successfully retrieved.",
...
router.patch("/user/:user_id", async (req, res) => {
  ...
  res.status(200).json({
    ...
    status: "200 - Ok",
    message:
      "List of notifications for " + user_id + " successfully updated to read.",
...
router.delete("/user/:user_id", async (req, res) => {
  ...
  res.status(200).json({
    ...
    status: "200 - Ok",
    message:
      "List of notifications for user " + user_id + " successfully deleted.",
  });
});
